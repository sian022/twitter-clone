...
function HeartButton({isLoading, onClick, likedByMe, likeCount}: HeartButtonProps) {
  ...
  return (
    ...
    disabled={isLoading}
    onClick={onClick}
    className={`group items-center gap-1 self-start flex transition-colors duration-200 -ml-2 ${likedByMe ? "text-red-500" : "text-gray-500 hover:text-red-500 focus-visible:text-red-500"   }`}>
      <IconHoverEffect red>
